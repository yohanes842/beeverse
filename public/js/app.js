...
__webpack_require__(/*! ./bootstrap */ "./resources/js/bootstrap.js"); //Nav active
...
var close_btn = document.getElementById("close_toast");
close_btn === null || close_btn === void 0 ? void 0 : close_btn.addEventListener("click", function () {
  Toast.classList.remove("show");
}); //Hobbies

var hobbyFieldContainer = document.getElementById("hobby-field-container");
var addFieldBtn = document.getElementById("add-field-btn");
addFieldBtn === null || addFieldBtn === void 0 ? void 0 : addFieldBtn.addEventListener("click", function () {
...
var querySearch = document.getElementById("queryInput");
var formSearch = document.getElementById("formSearch");
var genderFinal = document.getElementById("gender-key");
var searchFinal = document.getElementById("search-key");
var formFilter = document.getElementById("formFilter");
formFilter === null || formFilter === void 0 ? void 0 : formFilter.addEventListener("submit", function (e) {
  e.preventDefault();
  genderFinal === null || genderFinal === void 0 ? void 0 : genderFinal.setAttribute("value", gender.value);
  searchFinal === null || searchFinal === void 0 ? void 0 : searchFinal.setAttribute("value", querySearch.value);
  formFilter.submit();
});
gender === null || gender === void 0 ? void 0 : gender.addEventListener("change", function () {
  genderFinal === null || genderFinal === void 0 ? void 0 : genderFinal.setAttribute("value", gender.value);
  searchFinal === null || searchFinal === void 0 ? void 0 : searchFinal.setAttribute("value", querySearch.value);
  formFilter.submit();
});
formSearch === null || formSearch === void 0 ? void 0 : formSearch.addEventListener("submit", function (e) {
  e.preventDefault();
  genderFinal === null || genderFinal === void 0 ? void 0 : genderFinal.setAttribute("value", gender.value);
  searchFinal === null || searchFinal === void 0 ? void 0 : searchFinal.setAttribute("value", querySearch.value);
  formFilter.submit();
...
var giftBtn = Array.from(document.querySelectorAll(".gift-btn"));
var giftInput = Array.from(document.querySelectorAll(".gift-input"));
giftBtn === null || giftBtn === void 0 ? void 0 : giftBtn.forEach(function (e) {
  var avatar = e.getAttribute("avatar");
  e.addEventListener("click", function () {
    giftInput === null || giftInput === void 0 ? void 0 : giftInput.forEach(function (e) {
      e.value = avatar;
    });
  });
});
